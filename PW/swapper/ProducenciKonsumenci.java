...
public class ProducenciKonsumenci {
    ...
    private static  Semafor zajęte;
    private static Semafor wolne;

    private static BinarnySemafor mutexZajętych;
    private static BinarnySemafor mutexWolnych;
    ...
    public static void main(String args[]) {
    	try {
	    	zajęte = new Semafor(0);
	    	wolne = new Semafor(ROZMIAR);
	    	mutexZajętych = new BinarnySemafor(1);
	    	mutexWolnych = new BinarnySemafor(1);
    	} catch (InterruptedException e) {
